...
try:  # pragma: no cover - import guard for user friendliness
    import numpy as np
    import pandas as pd
    import torch
    ...
    raise SystemExit(
        "own_delivery_full.py requires the '{missing}' dependency. "
        "Install everything with `pip install -r requirements.txt` before running."
